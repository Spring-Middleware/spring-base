...
The platform BOM `io.github.spring-middleware:bom:1.6.0` manages the versions of core modules used by Spring Middleware. Key module versions included in the BOM are:

...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <properties>
        ...
        <spring-middleware.api.version>1.6.0</spring-middleware.api.version>
        <spring-middleware.app.version>1.9.0</spring-middleware.app.version>
        <spring-middleware.mongo-core.version>1.7.0</spring-middleware.mongo-core.version>
        <spring-middleware.kafka-core.version>1.6.0</spring-middleware.kafka-core.version>
        <spring-middleware.graphql.version>1.6.0</spring-middleware.graphql.version>
